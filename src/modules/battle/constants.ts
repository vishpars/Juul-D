...
export const PERMANENT_EFFECT_PHRASES = [
    ...
    "Пожизненно",
      // --- Игры и Технологии ---
  "Сюжетная броня",                // Термин, когда героя нельзя убить ради сюжета
  "Режим Бога (IDDQD)",            // Классика Doom
  "Прочность Nokia 3310",          // Мем о неуничтожимости телефона
  "Хардкод",                       // Прописано жестко в коде, не изменить
  "Это не баг, а фича",            // Классическое оправдание разработчиков
  "Uptime 100%",                   // Серверный термин, работает без сбоев
  "Сохранено в облаке",            // Никуда не денется
  "Текстура майнкрафта",           // Простой и вечный блок
  "Press F to pay respect",        // Мем из CoD (тут в значении вечного уважения/эффекта)
  "Алмазная кирка",                // Minecraft: долговечность
  "Защита от дурака",              // Инженерный термин

  // --- Кино и Поп-культура ---
  "Таков путь",                    // Мандалорец
  "Безграничная мощь!",            // Звездные войны (Палпатин)
  "Ваканда навеки",                // Черная Пантера
  "Я могу делать это весь день",   // Капитан Америка
  "Кольцо Всевластия",             // Властелин Колец (в значении вечной привязки)
  "Философский камень",            // Гарри Поттер / Алхимия (вечная жизнь)
  "Пятый элемент",                 // Мультипаспорт!
  "Как Хатико",                    // Символ вечной верности/ожидания
  "Дункан Маклауд",                // Горец (бессмертный)

  // --- Бытовые и Жизненные (Сарказм) ---
  "На синей изоленте",             // В СНГ считается, что она держит вечно
  "Как очередь в поликлинику",     // Бесконечно долгая
  "Советское качество",            // Сделано на века
  "Тавро Казначейства",            // Бюрократическая печать
  "Приклеено на «Момент»",         // Суперклей
  "Несгораемая сумма",             // Из "Кто хочет стать миллионером"
  "Как ремонт у соседей",          // Никогда не заканчивается
  "Заводские настройки",           // Изначальное состояние

  // --- Эпичные и Пафосные ---
  "Высечено в камне",              // Неизменяемо
  "Аксиома",                       // Не требует доказательств
  "Столп мироздания",              // Фундаментальная часть мира
  "Эффект бабочки",                // Малое, влияющее на все будущее
  "Абсолют",                       // Высшая степень
  "Perpetuum Mobile",              // Вечный двигатель (латынь)
  "Во веки веков",                 // Библейское/Эпическое
  "Константа"                      // Математическая постоянная
];
